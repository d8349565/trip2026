...
import { Map, Calendar, Image, ClipboardList, Plus } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <button 
        ...
        className={`flex flex-col items-center justify-center gap-1 w-14 h-12 transition-all ${currentView === 'checklist' ? 'text-blue-600 scale-105' : 'hover:text-slate-600'}`}
      >
